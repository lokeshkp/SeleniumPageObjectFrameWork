...
public class DataProviders {
	...
	public static Object[][] VerifyingDriverDetails(Method m){
		...
		System.out.println(m.getName());
		ExcelReader excel = new ExcelReader(ExcelConstants.JOURNEYSUITE_XL_PATH);		
		String testcase = m.getName();		
		return ExcelUtils.getData(testcase, excel);
	...
	@DataProvider(name="VerifyHarshBrakeAndAccelerationsReport")
	public static Object[][] VerifyHarshBrakeAndAccelerationsReport(Method m){
	...
	@DataProvider(name="VerifyDriverDailySummary")
	public static Object[][] VerifyDriverDailySummary(Method m){
	...
	public static Object[][] Verifyingjourneyview(Method m){
	 ...
	 @DataProvider(name ="AssetPanelTabsData")
	    public static Object[][] AssetPanelTabsData(Method m) throws Exception{
		  ...
		  System.out.println(m.getName());
			ExcelReader excel = new ExcelReader(ExcelConstants.ASSETSUITE_XL_PATH);
